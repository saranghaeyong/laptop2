...
export const Laptop: React.FC<LaptopProps> = ({
  ...
  useFrame((state) => {
    ...
    if (prefersReducedMotion) {
      ...
      rootGroupRef.current.rotation.y = targetRotationRef.current.y;
      rootGroupRef.current.rotation.x = targetRotationRef.current.x;
      return;
    }
    ...
    const floatAmplitude = isExploded ? 0.03 : 0.07;
    const rotAmplitude = isExploded ? 0.012 : 0.025;
